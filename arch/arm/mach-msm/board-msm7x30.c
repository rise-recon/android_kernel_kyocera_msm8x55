...
#include <mach/keypad_androidkey.h>
#endif /* CONFIG_TARGET_PROTOTYPE_WS0 */


#ifdef CONFIG_TARGET_PRODUCT_C5155
#include <mach/slide_switch.h>
#endif /* CONFIG_TARGET_PRODUCT_C5155 */
...
#define PM_VIB_DRIV 3 /* PMIC MPP 04 */


#define   I2C_DEVICE_ID_0     (8)
#define   I2C_DEVICE_ID_1     (9)
#define   I2C_DEVICE_ID_2     (10)
#define   I2C_DEVICE_ID_3     (11)


#ifndef CONFIG_TARGET_PROTOTYPE_WS2
#ifdef CONFIG_TARGET_PRODUCT_C5155
#define   I2C_DEVICE_ID_4     (12)
#endif /* CONFIG_TARGET_PRODUCT_C5155 */
...
#if defined (FEATURE_KYOCERA_MSND) || defined (FEATURE_KYOCERA_MCAM)
DEFINE_MUTEX(msm_5vcnt_mutex);
#endif


unsigned GPIO_CAM_SCL;
unsigned GPIO_CAM_SDA;
...
static int pm8058_gpios_init(void)
{
	...
	/* 5V_CNT */
	struct pm8xxx_gpio_init_info pm_gpio_5v_cnt = {
		GPIO_5V_CNT,
		{
			.direction      = PM_GPIO_DIR_OUT,
			.output_buffer  = PM_GPIO_OUT_BUF_CMOS,
	...
	/* WLAN_RST */
	struct pm8xxx_gpio_init_info pm_gpio_wlan_rst = {
		GPIO_WLAN_RST,
		{
			.direction      = PM_GPIO_DIR_OUT,
			.output_buffer  = PM_GPIO_OUT_BUF_CMOS,
	...
	/* LED_PWM_D */
	struct pm8xxx_gpio_init_info pm_gpio_led_pwm_d = {
		GPIO_LED_PWM_D,
		{
			.direction      = PM_GPIO_DIR_OUT,
			.output_buffer  = PM_GPIO_OUT_BUF_CMOS,
...
#if defined(CONFIG_TARGET_PROTOTYPE_WS0)  || defined(CONFIG_TARGET_PROTOTYPE_WS1)
	/* LIGHT_EN */
	struct pm8xxx_gpio_init_info pm_gpio_light_en = {
		GPIO_LIGHT_EN,
		{
			.direction      = PM_GPIO_DIR_OUT,
			.output_buffer  = PM_GPIO_OUT_BUF_CMOS,
	...
	/* FLASH_EN */
	struct pm8xxx_gpio_init_info pm_gpio_flash_en = {
		GPIO_FLASH_EN,
		{
			.direction      = PM_GPIO_DIR_OUT,
			.output_buffer  = PM_GPIO_OUT_BUF_CMOS,
...
#else
	struct pm8xxx_gpio_init_info pm_gpio_25 = {
		PM_GPIO_25,
		{
                        .direction      = PM_GPIO_DIR_OUT,
                        .output_buffer  = PM_GPIO_OUT_BUF_CMOS,
	...
	struct pm8xxx_gpio_init_info pm_gpio_26 = {
		PM_GPIO_26,
		{
                        .direction      = PM_GPIO_DIR_OUT,
                        .output_buffer  = PM_GPIO_OUT_BUF_CMOS,
...
#endif /* defined(CONFIG_TARGET_PROTOTYPE_WS0)  || defined(CONFIG_TARGET_PROTOTYPE_WS1) */

	/* AUDIO_RST */
	struct pm8xxx_gpio_init_info pm_gpio_audio_rst = {
		GPIO_AUD_RST,
		{
			.direction      = PM_GPIO_DIR_OUT,
			.output_buffer  = PM_GPIO_OUT_BUF_CMOS,
	...
	/* SLEEP_CLK1 */
	struct pm8xxx_gpio_init_info pm_gpio_sleep_clk1 = {
		GPIO_SLEEP_CLK1,
		{
			.direction      = PM_GPIO_DIR_OUT,
			.output_buffer  = PM_GPIO_OUT_BUF_CMOS,
	...
	/* HW_ID0 */
	struct pm8xxx_gpio_init_info pm_gpio_hw_id0 = {
		GPIO_HW_ID0,
		{
			.direction      = PM_GPIO_DIR_IN,
			.pull           = PM_GPIO_PULL_NO,
	...
	/* HW_ID1 */
	struct pm8xxx_gpio_init_info pm_gpio_hw_id1 = {
		GPIO_HW_ID1,
		{
			.direction      = PM_GPIO_DIR_IN,
			.pull           = PM_GPIO_PULL_NO,
	...
	/* HW_ID2 */
	struct pm8xxx_gpio_init_info pm_gpio_hw_id2 = {
		GPIO_HW_ID2,
		{
			.direction      = PM_GPIO_DIR_IN,
			.pull           = PM_GPIO_PULL_NO,
	...
	/* MAIN_ANT_SW_AWS */
	struct pm8xxx_gpio_init_info pm_gpio_main_ant_sw_aws = {
		GPIO_MAIN_ANT_SW_AWS,
		{
			.direction      = PM_GPIO_DIR_IN,
	...
	/* MAIN_ANT_SW_PCSCELLULAR */
	struct pm8xxx_gpio_init_info pm_gpio_main_ant_sw_pcscellular = {
		GPIO_MAIN_ANT_SW_PCSCELLULAR,
		{
			.direction      = PM_GPIO_DIR_IN,
			.pull           = PM_GPIO_PULL_DN,
			.vin_sel        = PM8058_GPIO_VIN_S3,
	...
	/* SUB_ANT_SW_PCSCELLULAR */
	struct pm8xxx_gpio_init_info pm_gpio_sub_ant_sw_pcscellular = {
		GPIO_SUB_ANT_SW_PCSCELLULAR,
		{
			.direction      = PM_GPIO_DIR_IN,
			.pull           = PM_GPIO_PULL_DN,
			.vin_sel        = PM8058_GPIO_VIN_S3,
...
#endif /* !defined(CONFIG_TARGET_PROTOTYPE_WS0) */


#ifdef CONFIG_TARGET_PROTOTYPE_WS0

	rc |= pm8xxx_gpio_config(pm_gpio_5v_cnt.gpio, &pm_gpio_5v_cnt.config);
#endif /* CONFIG_TARGET_PROTOTYPE_WS0 */

	rc |= pm8xxx_gpio_config(pm_gpio_wlan_rst.gpio,   &pm_gpio_wlan_rst.config);
	rc |= pm8xxx_gpio_config(pm_gpio_led_pwm_d.gpio,  &pm_gpio_led_pwm_d.config);
#if defined(CONFIG_TARGET_PROTOTYPE_WS0)  || defined(CONFIG_TARGET_PROTOTYPE_WS1)
	rc |= pm8xxx_gpio_config(pm_gpio_light_en.gpio,   &pm_gpio_light_en.config);
	rc |= pm8xxx_gpio_config(pm_gpio_flash_en.gpio,   &pm_gpio_flash_en.config);
#else
	rc |= pm8xxx_gpio_config(pm_gpio_25.gpio,   &pm_gpio_25.config);
	rc |= pm8xxx_gpio_config(pm_gpio_26.gpio,   &pm_gpio_26.config);
#endif /* defined(CONFIG_TARGET_PROTOTYPE_WS0)  || defined(CONFIG_TARGET_PROTOTYPE_WS1) */
	rc |= pm8xxx_gpio_config(pm_gpio_audio_rst.gpio,  &pm_gpio_audio_rst.config);
	rc |= pm8xxx_gpio_config(pm_gpio_sleep_clk1.gpio, &pm_gpio_sleep_clk1.config);


#if !defined(CONFIG_TARGET_PROTOTYPE_WS0)
	rc |= pm8xxx_gpio_config(pm_gpio_hw_id0.gpio,                  &pm_gpio_hw_id0.config);
	rc |= pm8xxx_gpio_config(pm_gpio_hw_id1.gpio,                  &pm_gpio_hw_id1.config);
	rc |= pm8xxx_gpio_config(pm_gpio_hw_id2.gpio,                  &pm_gpio_hw_id2.config);
	rc |= pm8xxx_gpio_config(pm_gpio_main_ant_sw_aws.gpio,         &pm_gpio_main_ant_sw_aws.config);
	rc |= pm8xxx_gpio_config(pm_gpio_main_ant_sw_pcscellular.gpio, &pm_gpio_main_ant_sw_pcscellular.config);
	rc |= pm8xxx_gpio_config(pm_gpio_sub_ant_sw_pcscellular.gpio,  &pm_gpio_sub_ant_sw_pcscellular.config);
#endif /* !defined(CONFIG_TARGET_PROTOTYPE_WS0) */


	if (rc)
	{
		pr_err("%s : Fail to set PMIC GPIO! rc %d\n", __func__, rc);
		return rc;
	}
...
/* Changed the assignment KEY_UP,KEY_DOWN,KEY_LEFT,KEY_RIGHT. */
...
static const unsigned int surf_keymap[] = {
	...
	KEY(5, 3, KEY_J),
	KEY(5, 5, KEY_SPACE),
	KEY(5, 6, KEY_LEFTALT), /* FN */

	KEY(6, 0, KEY_P),
	KEY(6, 4, KEY_CAPSLOCK), /* SHIFT */
	KEY(6, 5, KEY_RIGHT),/* Assigned to KEY_UP on the HW specification. */
	KEY(6, 6, KEY_LEFT), /* Assigned to KEY_DOWN on the HW specification. */

	KEY(7, 1, KEY_I),
	KEY(7, 2, KEY_U),
	KEY(7, 3, KEY_O),
	KEY(7, 4, KEY_ENTER),
	KEY(7, 5, KEY_UP),  /* Assigned to KEY_LEFT on the HW specification. */
	KEY(7, 6, KEY_DOWN),/* Assigned to KEY_RIGHT on the HW specification. */
...
#ifdef CONFIG_KYOCERA_ORIGINAL_FEATURE
	.input_name		= "kc-keypad",
	.input_phys_device	= "kc-keypad/input0",
	.num_rows		= 8,
	.num_cols		= 7,
...
static struct pmic8058_led pmic8058_oem_leds[] = {
	[0] = {
...
static struct pmic8058_leds_platform_data pm8058_oem_leds_data = {
	.num_leds = ARRAY_SIZE(pmic8058_oem_leds),
	.leds	= pmic8058_oem_leds,
};
...
static struct i2c_board_info msm_camera_boardinfo[] __initdata = {
	...
	{
		I2C_BOARD_INFO("camera_qup", 0x40 >> 1),
	},
#endif 
...
#ifdef FEATURE_KYOCERA_MCAM
static struct msm_camera_sensor_flash_data flash_camsensor = {
  .flash_type = MSM_CAMERA_FLASH_LED,
  .flash_src  = &msm_flash_src_pwm
};

static struct msm_camera_sensor_info msm_camera_camsensor_drv_data = {
  .sensor_name    = MCAM_SENSOR_NAME,
  .pdata          = &msm_camera_device_data,
  .flash_data     = &flash_camsensor,
  .resource       = msm_camera_resources,
  .num_resources  = ARRAY_SIZE(msm_camera_resources),
  .csi_if         = 0
};

static struct platform_device msm_camera_camsensor_drv = {
  .name      = MCAM_SENSOR_DEVICE_NAME,
  .dev       = {
    .platform_data = &msm_camera_camsensor_drv_data,
  },
};
#endif
...
#ifdef FEATURE_KYOCERA_MSND
void msm_snddev_rcv_on(void)
{
  kcj_dev_info_update_snd(DEV_INFO_SND_RECEIVER, true);
}

void msm_snddev_rcv_off(void)
{
  kcj_dev_info_update_snd(DEV_INFO_SND_RECEIVER, false);
}

void msm_snddev_tty_hsed_on(void)
{
  kcj_dev_info_update_snd(DEV_INFO_SND_HEADSET, true);
}

void msm_snddev_tty_hsed_off(void)
{
  kcj_dev_info_update_snd(DEV_INFO_SND_HEADSET, false);
}
#endif
...
void msm_snddev_poweramp_on(void)
{
  ...
  msm_5vcnt_exclusion(true, MSM_5VCNT_USER_SOUND);

  msleep(50);

  HS_A_SPK_ON1_HI();

  kcj_dev_info_update_snd(DEV_INFO_SND_SPEAKER, true);
...
void msm_snddev_poweramp_off(void)
{
  ...
  msm_5vcnt_exclusion(false, MSM_5VCNT_USER_SOUND);

  kcj_dev_info_update_snd(DEV_INFO_SND_SPEAKER, false);
...
#if 0
	int rc;
	printk(KERN_NOTICE "%s()client_id = 0x%x\n", __func__, client_id);
...
static struct msm_panel_common_pdata mdp_pdata = {
	...
	.gpio = 19,
#else /* CONFIG_TARGET_PROTOTYPE_WS0 */
	.gpio = 30,
...
#ifdef FEATURE_KYOCERA_MCAM
	{ GPIO_CFG(GPIO_0, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), "qup_scl" },
	{ GPIO_CFG(GPIO_1, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), "qup_sda" },
#else
...
#ifdef FEATURE_KYOCERA_MCAM
	{ GPIO_CFG(GPIO_0, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), "qup_scl" },
	{ GPIO_CFG(GPIO_1, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), "qup_sda" },
#else
...
static u32 i2c_devices_gpio_cfg[][2] = {
  {
    GPIO_CFG(GPIO_I2C_SENSOR_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
    GPIO_CFG(GPIO_I2C_SENSOR_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA)
  },
  {
    GPIO_CFG(GPIO_I2C_TP_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
    GPIO_CFG(GPIO_I2C_TP_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA)
  },
  {
    0,
    0
  ...
  {
    GPIO_CFG(GPIO_I2C_PROX_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
    GPIO_CFG(GPIO_I2C_PROX_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA)
  },
...
#ifdef CONFIG_TARGET_PRODUCT_C5155
  {
    GPIO_CFG(GPIO_AMP_SCL, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
    GPIO_CFG(GPIO_AMP_SDA, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA)
  },
#endif /* CONFIG_TARGET_PRODUCT_C5155 */
#endif /* CONFIG_TARGET_PROTOTYPE_WS2 */
...
static struct i2c_gpio_platform_data i2c_devices_pdata[] = {
  {
  ...
  {
    .sda_pin        = GPIO_I2C_TP_SDA,
    .sda_is_open_drain  = 0,
    .scl_pin        = GPIO_I2C_TP_SCL,
    .scl_is_open_drain  = 0,
    .udelay         = 1,
  },
  {
  ...
  {
    .sda_pin        = GPIO_I2C_PROX_SDA,
    .sda_is_open_drain  = 0,
    .scl_pin        = GPIO_I2C_PROX_SCL,
    .scl_is_open_drain  = 0,
    .udelay         = 1,
  },
...
#ifdef CONFIG_TARGET_PRODUCT_C5155
  {
    .sda_pin        = GPIO_AMP_SDA,
    .sda_is_open_drain  = 0,
    .scl_pin        = GPIO_AMP_SCL,
    .scl_is_open_drain  = 0,
    .udelay         = 1,
  },
#endif /* CONFIG_TARGET_PRODUCT_C5155 */
...
static struct platform_device msm_soft_i2c_device[] = {
  {
    .name           = "i2c-gpio",
    .id         = I2C_DEVICE_ID_0,
    .dev.platform_data  = &i2c_devices_pdata[0],
  },
  {
    .name           = "i2c-gpio",
    .id         = I2C_DEVICE_ID_1,
    .dev.platform_data  = &i2c_devices_pdata[1],
  },
  {
    .name           = "i2c-gpio",
    .id         = I2C_DEVICE_ID_2,
    .dev.platform_data  = &i2c_devices_pdata[2],
  },
  {
    .name           = "i2c-gpio",
    .id         = I2C_DEVICE_ID_3,
    .dev.platform_data  = &i2c_devices_pdata[3],
  },
...
#ifdef CONFIG_TARGET_PRODUCT_C5155
  {
    .name           = "i2c-gpio",
    .id         = I2C_DEVICE_ID_4,
    .dev.platform_data  = &i2c_devices_pdata[4],
  },
#endif /* CONFIG_TARGET_PRODUCT_C5155 */
#endif /* CONFIG_TARGET_PROTOTYPE_WS2 */
...
static struct i2c_board_info msm_i2c_board_info0[] __initdata = {
	{
...
static struct i2c_board_info msm_i2c_board_info1[] __initdata = {
	{
		I2C_BOARD_INFO("touchpanel", 0x4a),
	},
};
static struct i2c_board_info msm_i2c_board_info2[] __initdata = {
	{
		I2C_BOARD_INFO("camera1", 0x40 >> 1),
	},
};
static struct i2c_board_info msm_i2c_board_info3[] __initdata = {
	{
		I2C_BOARD_INFO("proximity", 0x39),
	},
};
...
#ifndef CONFIG_TARGET_PROTOTYPE_WS2
#ifdef CONFIG_TARGET_PRODUCT_C5155
static struct i2c_board_info msm_i2c_board_info4[] __initdata = {
	{
		I2C_BOARD_INFO("spkamp-kc", 0x18),
	},
};
#endif /* CONFIG_TARGET_PRODUCT_C5155 */
#endif /* CONFIG_TARGET_PROTOTYPE_WS2 */
...
*/
  ...
  HS_A_SET_GPIO_FOR_HW_ID();
  

  i2c_devices_pdata[CAM_GPIO_CFG_POS].scl_pin = GPIO_CAM_SCL;
  i2c_devices_pdata[CAM_GPIO_CFG_POS].sda_pin = GPIO_CAM_SDA;


  i2c_devices_gpio_cfg[CAM_GPIO_CFG_POS][0] =
        GPIO_CFG(GPIO_CAM_SCL, 0, GPIO_CFG_INPUT,
                 GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA);
  i2c_devices_gpio_cfg[CAM_GPIO_CFG_POS][1] =
        GPIO_CFG(GPIO_CAM_SDA, 0, GPIO_CFG_INPUT,
                 GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA);
	
  for(i = 0; i < ARRAY_SIZE(msm_soft_i2c_device); i++){
    gpio_tlmm_config(i2c_devices_gpio_cfg[i][0], GPIO_CFG_ENABLE); /* scl_pin */
    gpio_tlmm_config(i2c_devices_gpio_cfg[i][1], GPIO_CFG_ENABLE); /* sda_pin */
    platform_device_register(&msm_soft_i2c_device[i]);
  }
...
static uint32_t msm_sdcc_setup_gpio(int dev_id, unsigned int enable)
{
	...
	if (enable) {
		...
		if (curr->sleep_cfg_data) {
			...
			/* Gpio would be assert to current consumption for wlan.*/
			if(dev_id == KCJ_WIFI_SDIO_DEV_ID ) 
			{
				...
				printk(KERN_ERR "KCJ WLAN SDIO is disabled.\n");
			}


			/* 
			 * GPIO output is set to LOW setting for SDC4
			 */
		    if(dev_id == 4) {
				gpio_set_value(58, 0);
				gpio_set_value(59, 0);
...
static uint32_t msm_sdcc_setup_vreg(int dev_id, unsigned int enable)
{
	...
	/* OFF to enable the processing of dynamic VREG_L15 */
#if 0
...
static unsigned int msm7x30_sdcc_slot_status(struct device *dev)
{
	...
	ret = gpio_get_value(GPIO_CARD_DETB);
...
/*	.status_irq  = PM8058_GPIO_IRQ(PMIC8058_IRQ_BASE, PMIC_GPIO_SD_DET - 1), */
	.status_irq  = MSM_GPIO_TO_INT(GPIO_CARD_DETB),
...
*/
	pm8058_7x30_data.leds_pdata = &pm8058_oem_leds_data;
}
...
int vib_mpp_config(void)
{
	struct pm8xxx_mpp_config_data vib_mpp = {
	         .type = PM8XXX_MPP_TYPE_D_INPUT,
	         .level = PM8018_MPP_DIG_LEVEL_S3,
	         .control = PM8XXX_MPP_DIN_TO_DBUS2,
	};
	return pm8xxx_mpp_config(PM8058_MPP_PM_TO_SYS(PM_VIB_DRIV),
	                         &vib_mpp);
}
...
void hs_vreg_ctl(const char* vreg_name, enum switch_cmd onoff, int min_uV, int max_uV)
{
	static struct regulator *reg_ctrl;

	reg_ctrl = regulator_get(NULL, vreg_name);
	if (IS_ERR(reg_ctrl)) {
		pr_err("Unable to get regulator [%s]\n", vreg_name);
		return;
	}

	if (regulator_set_voltage(reg_ctrl, min_uV, max_uV))
	{
		pr_err("Unable to set_voltage regulator [%s]\n", vreg_name);
	}

	if (onoff)
	{
		if (regulator_enable(reg_ctrl))
		{
			pr_err("Unable to enable regulator [%s]\n", vreg_name);
		}
	}
	else
	{
		if (regulator_disable(reg_ctrl))
		{
			pr_err("Unable to disable regulator [%s]\n", vreg_name);
		}
	}

	regulator_put(reg_ctrl);
}

EXPORT_SYMBOL(hs_vreg_ctl);
...
#if defined (FEATURE_KYOCERA_MSND) || defined (FEATURE_KYOCERA_MCAM)
void msm_5vcnt_exclusion( bool onoff, msm_5vcnt_user_type user )
{
    static unsigned int msm_5vcnt_user = MSM_5VCNT_USER_NONE;
    msm_5vcnt_user_type user_5vcnt = user;
    
    mutex_lock( &msm_5vcnt_mutex );
    
    if( onoff == false )
    {
        user_5vcnt = ~user_5vcnt;
        msm_5vcnt_user &= user_5vcnt;
        
        if(( msm_5vcnt_user & 0xFFFFFFFF ) == 0 )
        {
            HS_A_5V_CNT_LO();
        }
    }
...
*/
	...
	i2c_register_board_info(I2C_DEVICE_ID_0, msm_i2c_board_info0,
		ARRAY_SIZE(msm_i2c_board_info0));  
	i2c_register_board_info(I2C_DEVICE_ID_1, msm_i2c_board_info1,
		ARRAY_SIZE(msm_i2c_board_info1));  
	i2c_register_board_info(I2C_DEVICE_ID_2, msm_i2c_board_info2,
		ARRAY_SIZE(msm_i2c_board_info2));  
	i2c_register_board_info(I2C_DEVICE_ID_3, msm_i2c_board_info3,
		ARRAY_SIZE(msm_i2c_board_info3));  


#ifndef CONFIG_TARGET_PROTOTYPE_WS2
#ifdef CONFIG_TARGET_PRODUCT_C5155
	i2c_register_board_info(I2C_DEVICE_ID_4, msm_i2c_board_info4,
		ARRAY_SIZE(msm_i2c_board_info4));  
#endif /* CONFIG_TARGET_PRODUCT_C5155 */
#endif /* CONFIG_TARGET_PROTOTYPE_WS2 */
