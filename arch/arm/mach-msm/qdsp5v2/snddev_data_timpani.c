...
#ifdef FEATURE_KYOCERA_MSND
	.pamp_on = msm_snddev_rcv_on,
	.pamp_off = msm_snddev_rcv_off,
#else
	.pamp_on = NULL,
	.pamp_off = NULL,
#endif
...
#ifdef FEATURE_KYOCERA_MSND
static struct snddev_ecodec_data snddev_bt_sco_earpiece_ec_off_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_rx_ec_off",
	.copp_id = 1,
...
static struct snddev_ecodec_data snddev_bt_sco_mic_ec_off_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_tx_ec_off",
	.copp_id = 1,
...
static struct platform_device msm_bt_sco_earpiece_ec_off_device = {
	.name = "msm_snddev_ecodec",
	.id = 2,
	.dev = { .platform_data = &snddev_bt_sco_earpiece_ec_off_data },
};

static struct platform_device msm_bt_sco_mic_ec_off_device = {
	.name = "msm_snddev_ecodec",
	.id = 3,
	.dev = { .platform_data = &snddev_bt_sco_mic_ec_off_data },
};
#endif
...
#ifdef FEATURE_KYOCERA_MSND
	.max_voice_rx_vol[VOC_NB_INDEX] =   550,
	.min_voice_rx_vol[VOC_NB_INDEX] = -1200,
	.max_voice_rx_vol[VOC_WB_INDEX] =   550,
...
#ifdef FEATURE_KYOCERA_MSND
static struct adie_codec_action_unit ispkr_mic_ffa_48KHz_osr256_actions[] =
	AMIC_SPKR_PRI_MONO_8000_OSR_256;

static struct adie_codec_hwsetting_entry ispkr_mic_ffa_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ispkr_mic_ffa_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ispkr_mic_ffa_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile ispkr_mic_ffa_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = ispkr_mic_ffa_settings,
	.setting_sz = ARRAY_SIZE(ispkr_mic_ffa_settings),
};
#endif
...
static struct snddev_icodec_data snddev_itty_mono_rx_data = {
	...
	.default_sample_rate = 48000,
#ifdef FEATURE_KYOCERA_MSND
	.pamp_on = msm_snddev_tty_hsed_on,
	.pamp_off = msm_snddev_tty_hsed_off,
#else
	.pamp_on = NULL,
	.pamp_off = NULL,
#endif
...
static struct snddev_icodec_data snddev_ispkr_mono_data = {
	...
	.pamp_on = msm_snddev_poweramp_on,
	.pamp_off = msm_snddev_poweramp_off,
#if defined(FEATURE_KYOCERA_MSND) && defined(CONFIG_TARGET_PRODUCT_C5170)
...
#else
	.max_voice_rx_vol[VOC_NB_INDEX] =  450,
	.min_voice_rx_vol[VOC_NB_INDEX] = -1050,
	.max_voice_rx_vol[VOC_WB_INDEX] =  450,
	.min_voice_rx_vol[VOC_WB_INDEX] = -1050
#endif
};
...
static struct adie_codec_action_unit iearpiece_voip_ffa_48KHz_osr256_actions[] =
	EAR_VOIP_PRI_MONO_8000_OSR_256; /* 8000 profile also works for 48k */

static struct adie_codec_hwsetting_entry iearpiece_voip_ffa_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = iearpiece_voip_ffa_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(iearpiece_voip_ffa_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile iearpiece_voip_ffa_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = iearpiece_voip_ffa_settings,
	.setting_sz = ARRAY_SIZE(iearpiece_voip_ffa_settings),
};

static struct snddev_icodec_data snddev_iearpiece_ffa_voip_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "handset_voip_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_SPKR_VOIP,
	.profile = &iearpiece_voip_ffa_profile,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct adie_codec_action_unit imic_voip_ffa_48KHz_osr256_actions[] =
	AMIC_VOIP_PRI_MONO_8000_OSR_256; /* 8000 profile also works for 48k */

static struct adie_codec_hwsetting_entry imic_voip_ffa_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = imic_voip_ffa_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(imic_voip_ffa_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile imic_voip_ffa_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = imic_voip_ffa_settings,
	.setting_sz = ARRAY_SIZE(imic_voip_ffa_settings),
};

static struct snddev_icodec_data snddev_imic_voip_ffa_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "handset_voip_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_MIC_VOIP,
	.profile = &imic_voip_ffa_profile,
	.channel_mode = 1,
	.pmctl_id = imic_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(imic_pmctl_id),
	.default_sample_rate = 48000,
...
static struct adie_codec_action_unit ispkr_mono_voip_48KHz_osr256_actions[] =
	SPEAKER_VOIP_PRI_MONO_48000_OSR_256;

static struct adie_codec_hwsetting_entry ispkr_mono_voip_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ispkr_mono_voip_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ispkr_mono_voip_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile ispkr_mono_voip_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = ispkr_mono_voip_settings,
	.setting_sz = ARRAY_SIZE(ispkr_mono_voip_settings),
};

static struct snddev_icodec_data snddev_ispkr_mono_voip_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "speaker_mono_voip_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPKR_PHONE_MONO_VOIP,
	.profile = &ispkr_mono_voip_profile,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
	...
	.min_voice_rx_vol[VOC_WB_INDEX] = -900
#else
	.max_voice_rx_vol[VOC_NB_INDEX] =  750,
	.min_voice_rx_vol[VOC_NB_INDEX] = -750,
	.max_voice_rx_vol[VOC_WB_INDEX] =  750,
	.min_voice_rx_vol[VOC_WB_INDEX] = -750
#endif
};

static struct adie_codec_action_unit imic_spkr_voip_ffa_48KHz_osr256_actions[] =
	AMIC_SPKR_VOIP_PRI_MONO_8000_OSR_256; /* 8000 profile also works for 48k */

static struct adie_codec_hwsetting_entry imic_spkr_voip_ffa_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = imic_spkr_voip_ffa_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(imic_spkr_voip_ffa_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile imic_spkr_voip_ffa_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = imic_spkr_voip_ffa_settings,
	.setting_sz = ARRAY_SIZE(imic_spkr_voip_ffa_settings),
};
...
static struct snddev_icodec_data snddev_ispkr_mic_voip_data = {
	...
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPKR_PHONE_MIC_VOIP,
	.profile = &imic_spkr_voip_ffa_profile,
	.channel_mode = 1,
	.pmctl_id = ispk_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(ispk_pmctl_id),
	.default_sample_rate = 48000,
...
static struct adie_codec_action_unit headset_voip_ab_cpls_48KHz_osr256_actions[] =
	HEADSET_VOIP_AB_CPLS_48000_OSR_256;

static struct adie_codec_hwsetting_entry headset_voip_ab_cpls_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = headset_voip_ab_cpls_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(headset_voip_ab_cpls_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile headset_voip_ab_cpls_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = headset_voip_ab_cpls_settings,
	.setting_sz = ARRAY_SIZE(headset_voip_ab_cpls_settings),
};

static struct snddev_icodec_data snddev_ihs_stereo_voip_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "headset_stereo_voip_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HEADSET_SPKR_STEREO_VOIP,
	.profile = &headset_voip_ab_cpls_profile,
	.channel_mode = 2,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct adie_codec_action_unit iheadset_mic_voip_tx_osr256_actions[] =
	AMIC1_HEADSET_VOIP_TX_MONO_PRIMARY_OSR256;

static struct adie_codec_hwsetting_entry iheadset_mic_voip_tx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = iheadset_mic_voip_tx_osr256_actions,
		.action_sz = ARRAY_SIZE(iheadset_mic_voip_tx_osr256_actions),
	}
};

static struct adie_codec_dev_profile iheadset_mic_voip_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = iheadset_mic_voip_tx_settings,
	.setting_sz = ARRAY_SIZE(iheadset_mic_voip_tx_settings),
};
...
static struct snddev_icodec_data snddev_headset_mic_voip_data = {
	...
	.copp_id = 0,
	.acdb_id = ACDB_ID_HEADSET_MIC_VOIP,
	.profile = &iheadset_mic_voip_profile,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct snddev_ecodec_data snddev_bt_sco_earpiece_voip_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_voip_rx",
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_SPKR_VOIP,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct snddev_ecodec_data snddev_bt_sco_mic_voip_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_voip_tx",
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_MIC_VOIP,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct snddev_ecodec_data snddev_bt_sco_earpiece_ec_off_voip_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_voip_rx_ec_off",
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_SPKR_EC_OFF_VOIP,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct snddev_ecodec_data snddev_bt_sco_mic_ec_off_voip_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "bt_sco_voip_tx_ec_off",
	.copp_id = 1,
	.acdb_id = ACDB_ID_BT_SCO_MIC_EC_OFF_VOIP,
	.channel_mode = 1,
	.conf_pcm_ctl_val = BT_SCO_PCM_CTL_VAL,
	.conf_aux_codec_intf = BT_SCO_AUX_CODEC_INTF,
	.conf_data_format_padding_val = BT_SCO_DATA_FORMAT_PADDING,
...
static struct adie_codec_action_unit iearpiece_hac_voip_ffa_48KHz_osr256_actions[] =
	EAR_HAC_VOIP_PRI_MONO_8000_OSR_256; /* 8000 profile also works for 48k */

static struct adie_codec_hwsetting_entry iearpiece_hac_voip_ffa_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = iearpiece_hac_voip_ffa_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(iearpiece_hac_voip_ffa_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile iearpiece_hac_voip_ffa_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = iearpiece_hac_voip_ffa_settings,
	.setting_sz = ARRAY_SIZE(iearpiece_hac_voip_ffa_settings),
};

static struct snddev_icodec_data snddev_hac_voip_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "hac_voip_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HAC_RX_VOIP,
	.profile = &iearpiece_hac_voip_ffa_profile,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct platform_device msm_iearpiece_voip_device = {
	.name = "snddev_icodec",
	.id = 30,
	.dev = { .platform_data = &snddev_iearpiece_ffa_voip_data },
};
static struct platform_device msm_imic_voip_device = {
	.name = "snddev_icodec",
	.id = 31,
	.dev = { .platform_data = &snddev_imic_voip_ffa_data },
};
static struct platform_device msm_ispkr_mono_voip_device = {
	.name = "snddev_icodec",
	.id = 32,
	.dev = { .platform_data = &snddev_ispkr_mono_voip_data },
};
...
static struct platform_device msm_headset_stereo_voip_device = {
	.name = "snddev_icodec",
	.id = 34,
	.dev = { .platform_data = &snddev_ihs_stereo_voip_rx_data },
};
...
static struct platform_device msm_bt_sco_earpiece_voip_device = {
	.name = "msm_snddev_ecodec",
	.id = 4,
	.dev = { .platform_data = &snddev_bt_sco_earpiece_voip_data },
};
static struct platform_device msm_bt_sco_mic_voip_device = {
	.name = "msm_snddev_ecodec",
	.id = 5,
	.dev = { .platform_data = &snddev_bt_sco_mic_voip_data },
};
static struct platform_device msm_bt_sco_earpiece_ec_off_voip_device = {
	.name = "msm_snddev_ecodec",
	.id = 6,
	.dev = { .platform_data = &snddev_bt_sco_earpiece_ec_off_voip_data },
};
static struct platform_device msm_bt_sco_mic_ec_off_voip_device = {
	.name = "msm_snddev_ecodec",
	.id = 7,
	.dev = { .platform_data = &snddev_bt_sco_mic_ec_off_voip_data },
};
static struct platform_device msm_hac_voip_rx_device = {
	.name = "snddev_icodec",
	.id = 36,
	.dev = { .platform_data = &snddev_hac_voip_rx_data },
};

static struct adie_codec_action_unit ispkr_mono_open_48KHz_osr256_actions[] =
	SPEAKER_PRI_MONO_OPEN_48000_OSR_256;

static struct adie_codec_hwsetting_entry ispkr_mono_open_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ispkr_mono_open_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ispkr_mono_open_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile ispkr_mono_open_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = ispkr_mono_open_settings,
	.setting_sz = ARRAY_SIZE(ispkr_mono_open_settings),
};

static struct snddev_icodec_data snddev_ispkr_mono_open_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "speaker_mono_open_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPKR_PHONE_MONO_OPEN,
	.profile = &ispkr_mono_open_profile,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct adie_codec_action_unit ispkr_mic_open_ffa_48KHz_osr256_actions[] =
	AMIC_SPKR_PRI_MONO_OPEN_8000_OSR_256; /* 8000 profile also works for 48k */

static struct adie_codec_hwsetting_entry ispkr_mic_open_ffa_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ispkr_mic_open_ffa_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ispkr_mic_ffa_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile ispkr_mic_open_ffa_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = ispkr_mic_open_ffa_settings,
	.setting_sz = ARRAY_SIZE(ispkr_mic_open_ffa_settings),
};

static struct snddev_icodec_data snddev_ispkr_mic_open_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "speaker_mono_open_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPKR_PHONE_MIC_OPEN,
	.profile = &ispkr_mic_open_ffa_profile,
	.channel_mode = 1,
	.pmctl_id = ispk_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(ispk_pmctl_id),
	.default_sample_rate = 48000,
...
static struct adie_codec_action_unit ispkr_mono_voip_open_48KHz_osr256_actions[] =
	SPEAKER_VOIP_PRI_MONO_OPEN_48000_OSR_256;

static struct adie_codec_hwsetting_entry ispkr_mono_voip_open_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ispkr_mono_voip_open_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(ispkr_mono_voip_open_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile ispkr_mono_voip_open_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = ispkr_mono_voip_open_settings,
	.setting_sz = ARRAY_SIZE(ispkr_mono_voip_open_settings),
};

static struct snddev_icodec_data snddev_ispkr_mono_voip_open_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "speaker_mono_voip_open_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPKR_PHONE_MONO_VOIP_OPEN,
	.profile = &ispkr_mono_voip_open_profile,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
...
static struct adie_codec_action_unit imic_spkr_voip_open_ffa_48KHz_osr256_actions[] =
	AMIC_SPKR_VOIP_PRI_MONO_OPEN_8000_OSR_256; /* 8000 profile also works for 48k */

static struct adie_codec_hwsetting_entry imic_spkr_voip_open_ffa_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = imic_spkr_voip_open_ffa_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(imic_spkr_voip_open_ffa_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile imic_spkr_voip_open_ffa_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = imic_spkr_voip_open_ffa_settings,
	.setting_sz = ARRAY_SIZE(imic_spkr_voip_open_ffa_settings),
};

static struct snddev_icodec_data snddev_ispkr_mic_voip_open_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "speaker_mono_voip_open_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPKR_PHONE_MIC_VOIP_OPEN,
	.profile = &imic_spkr_voip_open_ffa_profile,
	.channel_mode = 1,
	.pmctl_id = ispk_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(ispk_pmctl_id),
	.default_sample_rate = 48000,
...
static struct platform_device msm_ispkr_mono_open_device = {
	.name = "snddev_icodec",
	.id = 37,
	.dev = { .platform_data = &snddev_ispkr_mono_open_data },
};

static struct platform_device msm_ispkr_mic_open_device = {
	.name = "snddev_icodec",
	.id = 38,
	.dev = { .platform_data = &snddev_ispkr_mic_open_data },
};

static struct platform_device msm_ispkr_mono_voip_open_device = {
	.name = "snddev_icodec",
	.id = 39,
	.dev = { .platform_data = &snddev_ispkr_mono_voip_open_data },
};

static struct platform_device msm_ispkr_mic_voip_open_device = {
	.name = "snddev_icodec",
	.id = 40,
	.dev = { .platform_data = &snddev_ispkr_mic_voip_open_data },
};
...
static struct platform_device *snd_devices_ffa[] __initdata = {
	...
	&msm_hac_rx_device,
	&msm_bt_sco_earpiece_ec_off_device,
	&msm_bt_sco_mic_ec_off_device,
	&msm_iearpiece_voip_device,
	&msm_imic_voip_device,
	&msm_ispkr_mono_voip_device,
	&msm_ispkr_mic_voip_device,
	&msm_headset_stereo_voip_device,
	&msm_headset_mic_voip_device,
	&msm_bt_sco_earpiece_voip_device,
	&msm_bt_sco_mic_voip_device,
	&msm_bt_sco_earpiece_ec_off_voip_device,
	&msm_bt_sco_mic_ec_off_voip_device,
	&msm_hac_voip_rx_device,
	&msm_ispkr_mono_open_device,
	&msm_ispkr_mic_open_device,
	&msm_ispkr_mono_voip_open_device,
	&msm_ispkr_mic_voip_open_device,
#endif
};

#ifdef FEATURE_KYOCERA_MSND
static struct adie_codec_action_unit headset_ab_legacy_48KHz_osr256_actions[] =
	HEADSET_AB_LEGACY_48000_OSR_256;

static struct adie_codec_hwsetting_entry headset_ab_legacy_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = headset_ab_legacy_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(headset_ab_legacy_48KHz_osr256_actions),
	}
};

static struct adie_codec_action_unit itty_mono_rx_legacy_actions[] =
	TTY_HEADSET_MONO_RX_LEGACY_8000_OSR_256;

static struct adie_codec_hwsetting_entry itty_mono_rx_legacy_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = itty_mono_rx_legacy_actions,
		.action_sz = ARRAY_SIZE(itty_mono_rx_legacy_actions),
	},
};

static struct adie_codec_action_unit
	ihs_stereo_speaker_stereo_rx_legacy_48KHz_osr256_actions[] =
	HEADSET_STEREO_SPEAKER_STEREO_RX_LEGACY_48000_OSR_256;

static struct adie_codec_hwsetting_entry
	ihs_stereo_speaker_stereo_rx_legacy_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = ihs_stereo_speaker_stereo_rx_legacy_48KHz_osr256_actions,
		.action_sz =
		ARRAY_SIZE(ihs_stereo_speaker_stereo_rx_legacy_48KHz_osr256_actions),
	}
};

static struct adie_codec_action_unit headset_voip_ab_legacy_48KHz_osr256_actions[] =
	HEADSET_VOIP_AB_LEGACY_48000_OSR_256;

static struct adie_codec_hwsetting_entry headset_voip_ab_legacy_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = headset_voip_ab_legacy_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(headset_voip_ab_legacy_48KHz_osr256_actions),
	}
};


static void snddev_hsed_set_capless_to_legacy( void )
{
	struct platform_device *device;
	struct snddev_icodec_data *icodec_data;
	...
	icodec_data = (struct snddev_icodec_data *)device->dev.platform_data;
	if (icodec_data) {
			icodec_data->profile->settings = headset_ab_legacy_settings;
			icodec_data->profile->setting_sz = ARRAY_SIZE(headset_ab_legacy_settings);
	}

	device = &msm_itty_mono_rx_device;
	icodec_data = (struct snddev_icodec_data *)device->dev.platform_data;
	if (icodec_data) {
			icodec_data->profile->settings = itty_mono_rx_legacy_settings;
			icodec_data->profile->setting_sz = ARRAY_SIZE(itty_mono_rx_legacy_settings);
	}

	device = &msm_ihs_stereo_speaker_stereo_rx_device;
	icodec_data = (struct snddev_icodec_data *)device->dev.platform_data;
	if (icodec_data) {
			icodec_data->profile->settings = ihs_stereo_speaker_stereo_rx_legacy_settings;
			icodec_data->profile->setting_sz = ARRAY_SIZE(ihs_stereo_speaker_stereo_rx_legacy_settings);
	}

	device = &msm_headset_stereo_voip_device;
	icodec_data = (struct snddev_icodec_data *)device->dev.platform_data;
	if (icodec_data) {
			icodec_data->profile->settings = headset_voip_ab_legacy_settings;
			icodec_data->profile->setting_sz = ARRAY_SIZE(headset_voip_ab_legacy_settings);
	}
}
#endif
...
void __ref msm_snddev_init_timpani(void)
{
  ...
  {
    pr_err("HW_ID:%d set legacy mode\n",HS_HW_ID);
    snddev_hsed_set_capless_to_legacy();
  }
  else
  {
    pr_err("HW_ID:%d capless mode\n",HS_HW_ID);
  }
#endif
