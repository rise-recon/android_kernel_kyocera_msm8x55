...
#define MSM_CAMERA_LED_FLASH_OFF   5
#define MSM_CAMERA_LED_FLASH_AUTO  6
#define MSM_CAMERA_LED_FLASH_ON    7
#define MSM_CAMERA_LED_FLASH_TORCH 8
#endif
...
#ifdef FEATURE_KYOCERA_MCAM 
#define CFG_SET_DATALINE_MODE 36

#define CFG_PREPARE_SNAPSHOT 37
#define CFG_GET_EXIF_INFO    38
#define CFG_GET_SCENE_INFO   39
#define CFG_SET_SCENE        40
#define CFG_MAX 41
...
#ifdef FEATURE_KYOCERA_MCAM
#define SENSOR_DATALINE_CHECK_MODE 4
#endif

#ifdef FEATURE_KYOCERA_MCAM
#define SENSOR_STILL_TO_PREVIEW_MODE 5
#endif
...
typedef enum
{
  ...
  CAM_AEC_SPOT,
  CAM_AEC_MAX,
} camera_auto_exposure_type;

typedef enum
{
  CAM_AF_MODE_UNCHANGED,
  CAM_AF_MODE_NORMAL,   
  CAM_AF_MODE_MACRO,    
  CAM_AF_MODE_AUTO,     
  CAM_AF_MODE_MAX,
...
{
  camera_wb_type wb;
  camera_af_mode_type af_mode;
  camera_auto_exposure_type ae_mode;
  camera_iso_type iso;
  camera_flash_type flash;
  uint32_t brightness;
  camera_antiband_type antiband;
  int32_t exposure;
  uint16_t fps;
  int sharpness;
  uint32_t contrast;
...
#ifdef FEATURE_KYOCERA_MCAM
#ifdef FEATURE_KYOCERA_DLCHK_UVFIX_PATTERN
    common_dl_check_t dl_check;
#endif
    common_exif_info_t  exif_info;    
    camera_scene_info_type scene_info;
#endif
...
#ifdef FEATURE_KYOCERA_MCAM
#define MCAM_SENSOR_DEVICE_NAME "msm_camera_camsensor"
#define MCAM_SENSOR_NAME    "camsensor"
#define MCAM_I2C_NAME       "camera1"
#define MCAM_I2C_NAME_QUP   "camera_qup"
#endif
